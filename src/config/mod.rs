...
pub use schema::{
    ...
    HttpRequestConfig, IMessageConfig, IdentityConfig, ImageGenConfig, ImageGenerationConfig,
    ...
    McpConfig, McpServerConfig, McpTransport, MemoryConfig, MemoryPolicyConfig, Microsoft365Config,
